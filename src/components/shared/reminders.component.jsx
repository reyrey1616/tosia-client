  ...
  return (
    <div className="col-12 flex-wrap p-half" style={{ width: "100%" }}>
      ...
      <div style={{ padding: "3px" }} className="col-12 col-sm-12">
        <Alert
          message="Reminder"
          description="Reminder: Please complete this form on or before 11:59 PM of April 20, 2024 (Sunday). This portal will automatically close and will stop accepting responses beyond the deadline. Only applicants with complete requirements shall be accepted. Late submissions will not be tolerated."
          type="error"
        />
      </div>
      <div style={{ padding: "3px" }} className="col-12 col-sm-12">
