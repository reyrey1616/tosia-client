...
const Reminders = () => {
	return (
		<div className="col-12 flex -wrap" style={{ width: "100%" }}>
			<div className="p-half col-4 col-sm-12">
				<Alert
					message="Directions"
			...
			<div className="p-half col-4 col-sm-12">
				<Alert
					message="Reminder"
					description="Please complete this form on or before 11:59 PM of May 7, 2021 (Friday). This portal will automatically close and will stop accepting responses beyond the deadline. Only applicants with complete requirements shall be accepted. Late submissions will not be tolerated."
					type="error"
				/>
			</div>
			<div className="p-half col-4 col-sm-12">
