...
const CharacterReferences = ({ data, userType }) => {
  ...
  return (
    <div className="tab-page-container">
      {userType !== "evaluator" && userType !== "admin" && (
        <Form
          form={form}
          layout="vertical"
          name="basic"
            ...
            <div className="col-12 flex">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input character reference name",
                  },
                ]}
              >
                <Input allowClear />
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input position/Affiliation!",
                  },
                ]}
              >
                <Input allowClear />
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please input character reference contact number!",
                  },
                ]}
              >
                <Input allowClear />
